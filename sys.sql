...
show con_name;
alter session set container = orclpdb;
create user project identified by devpass;
alter pluggable database orclpdb open;
alter session set container = orclpdb;
create user developer identified by developer123;
grant create table developer;
alter user nagamani quota unlimited on users;
commit;
